    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('booking_kind', models.CharField(choices=[('room', 'Room'), ('experience', 'Experience')], max_length=15)),
                ('room_check_in', models.DateField(blank=True, null=True)),
                ('room_check_out', models.DateField(blank=True, null=True)),
